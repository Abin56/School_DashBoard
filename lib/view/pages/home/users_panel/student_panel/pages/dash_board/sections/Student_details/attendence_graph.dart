...
/// Represents StudentsAttendanceGraphView class
class StudentsAttendanceGraphView extends StatefulWidget {
  /// Creates the instance of StudentsAttendanceGraphView
  const StudentsAttendanceGraphView({Key? key}) : super(key: key);

  @override
  MyHomePageState createState() => MyHomePageState();
}

class MyHomePageState extends State<StudentsAttendanceGraphView> {
